...
function renderInterview() {
    ...
    <div class="space-y-4">
           <div>
                <h2 class="job-name mobile text-[18px]/[26px] font-semibold text-[#002C5C]">Mobile First Corp</h2>
                <p class=" job-skill text-base/5 text-[#64748B]">React Native Developer</p>
           </div>
            
           
            <p class=" job-time text-[14px] text-[#64748B]">Remote • Full-time • $130,000 - $175,000</p>
