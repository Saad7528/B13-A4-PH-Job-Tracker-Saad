...
const deleteButtonClass= document.querySelectorAll(".delete-btn")
...
function renderInterview() {
    ...
    <div class="space-y-4">
        ...
        <button class="  btn border-0 bg-white rounded-full delete-btn ">
...
function renderReject() {
    ...
    <div class="space-y-4">
        ...
        <div class="  btn border-0 bg-white rounded-full delete-btn ">
